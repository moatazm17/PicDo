  ...
  en: {
    translation: {
      ...
      result: {
        ...
        multipleTypesDetected: 'Multiple data types detected',
        edit: 'Edit',
        save: 'Save',
        cancel: 'Cancel',
        fullText: 'Full Text',
  ...
  ar: {
    translation: {
      ...
      result: {
        ...
        multipleTypesDetected: 'تم اكتشاف أنواع بيانات متعددة',
        edit: 'تعديل',
        save: 'حفظ',
        cancel: 'إلغاء',
        ...
        allPhoneNumbers: 'جميع أرقام الهاتف',
      ...
      errors: {
        ...
        limitReached: 'تم الوصول لحد الرفع',
        used: 'مستخدم',
        remaining: 'متبقي',
        resetsOn: 'يتجدد في',
        ...
        inappropriateContent: 'لا يمكن معالجة هذه الصورة. يرجى تجربة صورة أخرى.',
        maintenanceMode: 'الخدمة غير متاحة مؤقتاً للصيانة. يرجى المحاولة لاحقاً.',
